...
-- Java LSP managed by nvim-jdtls, disable from lspconfig
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        ...
        exclude_from_auto_enable = { 'jdtls' },
        handlers = {
          ...
          -- Prevent mason-lspconfig from setting up jdtls at all (handled by nvim-jdtls)
          ['jdtls'] = function() end,
        },
      }
    end,
  ...
  { -- Java LSP (uses nvim-jdtls instead of lspconfig)
